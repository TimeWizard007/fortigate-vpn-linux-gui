...
FortiGate VPN Linux GUI to niezależny, otwarty klient pulpitu dla FortiGate
SSL VPN na systemie Linux.
...
Wersja v0.1.x to fundament projektu. Łączność VPN oraz SAML/SSO są planowane
i nie są zaimplementowane.

| Temat | Dokument |
| ----- | -------- |
| Cel projektu | [purpose.md](purpose.md) |
| Planowana architektura | [architecture.md](architecture.md) |
